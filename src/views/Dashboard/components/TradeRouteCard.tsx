...
const TradeRouteCard = ({ title }: { title: string }) => {
  return (
    <Grid id={title}>
      <Wrapper>
        <TextRow1>
        ...
        <TextRow2>
          <SubHeading glowing>
            Users can earn passive income by depositing liquidity into trade routes. Trade route liquidity fuels the
        ...
        <ButtonRow>
          ...
          <a href="https://dex.NovaSpace.io /#/pool" rel="noopener noreferrer">
            <Button style={{ margin: '0 10px' }}>Get Liquidity</Button>
          </a>
          <a
            href="https://docs.NovaSpace.io/NovaSpace-documentation/how-farming-works"
            target="blank"
