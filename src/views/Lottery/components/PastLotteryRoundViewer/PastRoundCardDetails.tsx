...
import { Heading, CardBody, CardFooter, NovaRoundIcon, TicketRound } from '@pancakeswap-libs/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} NOVA`)}
              Icon={NovaRoundIcon}
            >
