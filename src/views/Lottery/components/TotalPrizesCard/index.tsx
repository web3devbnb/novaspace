...
import { Heading, Card, CardBody, CardFooter, Text, NovaRoundIcon, Flex, Skeleton } from '@pancakeswap-libs/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} NOVA</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
